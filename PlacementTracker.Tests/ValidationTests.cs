...
// Covers spec section 19 (edge cases) + 14.9 (validation).
public class ValidationTests
{
    private static IList<ValidationResult> Validate(Models.Application app)
    {
    ...
    {
        var errors = Validate(TestHelpers.ValidApplication());
        Assert.Empty(errors);
    }
